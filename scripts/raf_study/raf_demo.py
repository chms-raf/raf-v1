...
def main(run):
    ...
    # RAF Parameters
    state = 4               # determines experimental logic
    ...
    if debug:
        ...
        #3) Set mouth detection position
        ...
        # 4) Set food item pre-transfer position
        ...
        # 5) Set food item transfer position
        ...
        # 6) Set food item release on timeout position
        ...
        raf_msg = "Let's Eat Some Food Items!"
